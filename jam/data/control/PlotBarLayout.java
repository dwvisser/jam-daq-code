 ...
 * default size for some things
 *
 */

interface PlotBarLayout {
    ...
    static final int SCREEN_FONT_SIZE=12;	//fonts size screen

//    static final int PRINT_FONT_SIZE=18;    //windows?
    static final int PRINT_FONT_SIZE=12;	//Font size print
