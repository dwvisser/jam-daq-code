...
/**
 * Holds reference to the preferences node affecting the <code>jam.plot</code>
...
public final class PlotPreferences {
	...
	public static final Preferences PREFS = Preferences
			.userNodeForPackage(PlotPreferences.class);
	...
	/**
	 * Preference for whether to automatically rescale the counts axis on a zoom
	 * in or zoom out.
	 */
	public static final String AUTO_ON_EXPAND = "AutoOnExpand";

	/**
	 * Preference for whether to highlight gated channels, or simply draw the
	 * gate shape around them.
	 */
