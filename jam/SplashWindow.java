...
class SplashWindow extends JWindow {
	...
	private void drawWindow() {
		...
		final int sizexy = 80;
		nukeicon.setImage(nukeicon.getImage().getScaledInstance(sizexy, sizexy,
				Image.SCALE_SMOOTH));
		...
		east
				.setBorder(BorderFactory.createMatteBorder(1, 0, 0, 1,
						Color.BLACK));
		final JLabel osi = new JLabel(new ImageIcon(urlOSIGif));
		osi
				.setToolTipText("Open Source Initiative. See http://www.opensource.org/");
		east.add(osi);
