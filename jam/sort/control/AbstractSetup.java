...
abstract class AbstractSetup {
    ...
    protected static final Logger LOGGER = Logger
            .getLogger(AbstractSetup.class.getPackage().getName());
     ...
     */
    protected transient final AbstractButton bbrowsef = new JButton(
            "Browse...");
    ...
    public void selectFirstSortHistogram() {
        ...
        GuiceInjector.getObjectInstance(JamStatus.class).setCurrentGroup(
                sortGroup);
        final List<AbstractHistogram> histList = sortGroup.histograms
                .getList();
        if (!histList.isEmpty()) {
