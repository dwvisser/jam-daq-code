 ...
 * @since       JDK1.1
 */
public class L00XInputStream extends EventInputStream implements L002Parameters {
    ...
    /** 
     * Read in the header format of ORNL LOO2 data. The header may be L00*,
     *  i.e., allow for later versions
     * to be named in header.
     * 
     * Implemented <code>EventInputStream</code> abstract method.
     * @exception EventException thrown for unrecoverable errors
     * @return whether header was successfully read
     */
    public boolean readHeader() throws EventException {
        ...
        try {
            ...
            //matches except for character (usually '2' or '3') at index 11
            return (headerKey.regionMatches(false,0,HEADER_START,0,11) && 
            headerKey.regionMatches(false,12,HEADER_START,12,
            HEADER_START.length()-12));
