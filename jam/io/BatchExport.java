...
public final class BatchExport extends JDialog implements Observer {
    ...
    private void buildGUI() {
        ...
        pButton.add(bExport);
        final JButton bCancel = new JButton(
                new jam.ui.WindowCancelAction(this));
        pButton.add(bCancel);
        pBottom.add(pButton);
    ...
    private void export() {
        ...
        if (status) {
            for (int i = 0; i < exportDirList.size(); i++) {
                final boolean statusTemp = createExportDir(exportDirList
                        .get(i));
    ...
    private void loadList() {
        ...
        if (option == JFileChooser.APPROVE_OPTION
            ...
            try {
                ...
                do {
                    listItem = AbstractHistogram.getHistogram(reader
                            .readLine());
                    if (listItem != null) {
                        list.add(listItem);
                    }
