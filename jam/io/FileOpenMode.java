...
public final class FileOpenMode {
	...
	/**
	 * Returns whether this is one of the "Open" modes, which means that new
	 * data objects will get created by Jam from the data in the file.
	 * 
	...
	/**
	 * Mode for deleting the data in memory and replacing them with the contents
	 * of the file.
	 */
	...
	/**
	 * Mode for replacing the contents of data in memory with any objects in the
	 * file representing the same thing.
	 */
	public static final FileOpenMode RELOAD = new FileOpenMode(I_RELOAD);

	/**
	 * Mode for adding counts in histograms and scalers in the file to the
	 * counts of the same objects in memory.
	 */
	public static final FileOpenMode ADD = new FileOpenMode(I_ADD);
	/**
	 * Mode for adding counts in histograms and scalers in the file the first
	 * file opened
	 */
	public static final FileOpenMode ADD_OPEN_ONE = new FileOpenMode(
			I_ADD_OPEN_ONE);
