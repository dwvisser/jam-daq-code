...
public abstract class DataObject {
   ...
   /**
     ...
     */
    public DataObject(HDFile file, byte [] data, short reference){
	this.file=file;
	this.ref=reference;
	this.bytes=data;
     ...
     * @param	reference   The unique value specifying the type of data object.
     */
    public DataObject(HDFile file, int offset, int length, short reference){
	this.file=file;
	this.ref=reference;
	this.offset=offset;
	this.length=length;
    ...
    /**
     * Returns a 4-byte representation of the reference number, which is unique for any given
