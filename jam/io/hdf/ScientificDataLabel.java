...
public class ScientificDataLabel extends DataObject {
    ...
    public ScientificDataLabel(HDFile hdf, byte [] data, short reference) {
	...
	try{
	    numLabels=0;
	    lengthCounter=0;
	    lengths = new int[10]; //hard to imagine needing this many dimensions, so should be sufficient
	    ...
	    throw new HDFException ("Problem interpreting SDL: "+e.getMessage());
	}
    }
