...
public class LibVersion extends DataObject {
     ...
     * Descriptive String
     */
    String description = StringUtilities.makeLength(
    ...
    public LibVersion(HDFile hdf,byte [] data, short reference) {
	...
	try{//stuff coded as final so don't try to assign
	    ...
	    throw new HDFException ("Problem interpreting VERSION: "+e.getMessage());
	}
    }
}
