...
/**
 * This is an example sort routine for Jam. It sorts for a delta-E vs. E telescope. The histograms
 * consist of 1-d histograms for both Delta E and E, and a 2-d histogram which is gated on. The
 * event data are delta-E and E pulse heights. The convention for 2-d Histograms is x first, then y
 * (x vs y).
 *
 * @author Ken Swartz
 * @author Dale Visser
...
public class EvsDE extends AbstractSortRoutine {
  ...
  /**
   * Constructor, not usually necessary, but be sure to call <code>super()</code>.
   *
   * @see #initialize()
   */
  public EvsDE() {
