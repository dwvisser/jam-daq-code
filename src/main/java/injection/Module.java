...
public final class Module extends AbstractModule {
  ...
  protected void configure() {
    ...
    this.bind(FrontEndCommunication.class).to(FrontEndVMECommunicator.class);
    ...
    this.bind(CommandListener.class).annotatedWith(MapListener.class).to(CommandManager.class);
  }
}
