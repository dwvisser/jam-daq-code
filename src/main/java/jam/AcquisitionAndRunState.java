...
final class AcquisitionAndRunState implements PropertyChangeListener {
  ...
  /**
   * Sets run state when taking data online. The run state mostly determines the state of control
   * JMenu items. This method uses information set by <code>setSortMode()</code>. In addition:
   *
   * <ul>
   *   <li>Control JMenu items are enabled and disabled as appropriate.
   *   <li>Control JMenu items are states are set and unset as appropriate.
   *   <li>The JMenu bar is to show online sort.
   *   <li>Updates display status label .
   * </ul>
   *
  ...
  /**
   * Set the mode for sorting data, adjusting title and menu items as appropriate.
   *
