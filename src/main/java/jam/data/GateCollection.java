...
public final class GateCollection {
  ...
  private final transient int dimensions;

  /** gates that belong to this histogram */
  private final transient List<DataElement> gates = new ArrayList<>();
  ...
  public void addGate(final DataElement gate) {
    if (gate.getDimensionality() == dimensions) {
      ...
      throw new UnsupportedOperationException(
          "Can't add " + gate.getDimensionality() + "D gate to " + dimensions + "D histogram.");
    }
  }
