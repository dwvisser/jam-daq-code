...
/**
 * A polynomial histogram calibration function of up to 4th order, where energy is a polynomial in
 * the channel minus some offset.
 */
public class PolynomialOffsetFunction extends AbstractCalibrationFunction {

  /**
   * Creates a new <code>CalibrationFunction</code> object of the specified order of polynomial in
   * (x-x0).
   *
