 ...
 * @author Dale Visser
 */
public abstract class AbstractLinearRegressionFunction extends AbstractCalibrationFunction {

  /**
   * @param name name
   * @param numberTerms number of terms
   */
  public AbstractLinearRegressionFunction(final String name, final int numberTerms) {
    super(name, numberTerms);
  }

  /**
   * do a linear regression of data points y=a+bx returns to fit a, and b values in an array
   *
