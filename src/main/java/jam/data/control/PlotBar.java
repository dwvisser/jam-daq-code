...
public final class PlotBar extends JPanel {
  ...
  private static final Dimension MIN_SIZE = new Dimension(BAR_LENGTH, BAR_WIDTH);

  /**
   * Constructs a new bar widget for the given monitor.
   *
   * @param inMon monitor to display status of
   */
   ...
   *
   * @param inMon monitor object to observe
   */
