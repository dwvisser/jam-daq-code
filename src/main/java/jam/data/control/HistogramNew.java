...
public class HistogramNew extends AbstractControl {
  ...
  private final transient DefaultComboBoxModel<String> comboGroupModel;

  private final transient JTextField textName;

  private final transient JTextField textTitle;

  private final transient JComboBox<Integer> comboSize;

  private final transient JCheckBox coneInt, coneDbl, ctwoInt, ctwoDbl;

  private final transient JamStatus status;

  private static final Integer[] DEFAULT_SIZES = {64, 128, 256, 512, 1024, 2048, 4096, 8192};
   ...
   */
  @Inject
  public HistogramNew(final Frame frame, final JamStatus status, final Broadcaster broadcaster) {
    ...
    final JComboBox<String> comboGroup = new JComboBox<>(comboGroupModel);
  ...
  private void makeHistogram() {
    ...
    final AbstractHistogram hist = Factory.createHistogram(histGroup, array, name, title);
