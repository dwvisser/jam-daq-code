...
/**
 * Used anywhere a JComboBox is used to select from the available calibration functions.
 *
...
final class CalibrationComboBoxModel implements ComboBoxModel<Object> {
  ...
  private final transient Object selectSync = new Object();

  private final transient List<ListDataListener> listeners =
      Collections.synchronizedList(new ArrayList<ListDataListener>());
  ...
  /**
   * Can be called with an instance of the desired class or a reference to the class itself.
   *
  ...
  public void setSelectedItem(final Object anItem) {
    synchronized (selectSync) {
      String selectionNew;
      if (anItem == null) {
        selectionNew = CalibrationFunctionCollection.getListNames().get(0);
        ...
        throw new IllegalArgumentException(
            getClass().getName() + ": only AbstractCalibrationFunction, Strings or null");
      }
