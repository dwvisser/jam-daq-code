...
public class ScalerZero extends AbstractControl {
  ...
  private final transient JButton bzero2;

  private final transient JCheckBox chkDisable;
  ...
  @Inject
  public ScalerZero(
      final Frame frame, final BroadcastUtilities broadcast, final Broadcaster broadcaster) {
  ...
  /**
   * zero scalers, call broadcast which will sent it to the class that will zero the camac crate
   * scalers.
   */
  private void zero() {
