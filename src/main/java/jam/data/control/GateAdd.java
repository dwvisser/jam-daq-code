...
public final class GateAdd extends AbstractControl {
  ...
  private final transient JComboBox<Object> cadd;
   ...
   * @param gateListRender a renderer for the list of gates
   */
  @Inject
  public GateAdd(
