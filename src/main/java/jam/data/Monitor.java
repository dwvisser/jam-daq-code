...
/**
 * This class is for monitoring the status of data acquisition. Monitors can show the status of
...
public final class Monitor {
  ...
  /**
   * Constructs an object which monitors the rate of counts in a particular <code>Gate</code>.
   *
  ...
  public Monitor(final String monitorName, final Gate gate) {
    ...
    if (source == null) {
      throw new IllegalArgumentException(
          "Monitor \"" + monitorName + "\": source must be non-null.");
    }
    addToCollections();
  }

  /**
   * Constructs an object which monitors rate of increase in the given <code>Scaler</code>.
   *
   * @param monitorName name of the monitor for display in dialog
  ...
  /**
   * Gets whether this monitor value falls within the user-specified acceptable range.
   *
  ...
  /**
   * NOT YET IMPLEMENTED, Sets an <code>AudioClip</code> object to be played for alarms if the alarm
   * is enabled. Currently, the plan is to fully implement this when the JDK 1.2 <code>javax.media
  ...
  /**
   * Sets the maximum value, which is the maximum value for a monitor to have without <code>
   * MonitorControl</code> issuing a warning beep.
   *
  ...
  /**
   * Sets the threshold value, which is the minimum value for a monitor to have without <code>
   * MonitorControl</code> issuing a warning beep.
   *
  ...
  /**
   * Updates this monitor, calculating the latest monitor values. Keeps the most recent value, too,
