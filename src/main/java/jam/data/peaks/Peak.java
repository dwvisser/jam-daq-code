...
/**
 * This class represents a gaussian peak, in terms of it's properties. Fields are also provided for
 * the error bars on these properties.
 *
...
public final class Peak implements Comparable<Peak>, Cloneable {
   ...
   * Peak factory method.
   *
   * @param position of centroid
   * @param area of peak
   * @param width FWHM of peak
   * @return a new Peak object
   */
  public static Peak createPeak(final double position, final double area, final double width) {
   ...
   *
   * @param posn position of peak centroid
   * @param posnErr error on position
   * @param intensity area of peak
   * @param intErr uncertainty in area
   * @param wid FWHM of peak
   * @param widErr uncertainty in FWHM
   */
  private Peak(
      final double posn,
      final double posnErr,
