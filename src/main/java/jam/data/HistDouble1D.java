...
public final class HistDouble1D extends AbstractHist1D {
  ...
  HistDouble1D(
    ...
    super(jam.data.HistogramType.ONE_D_DOUBLE, countsIn.length, title, axisLabelX, axisLabelY);
    initCounts(countsIn);
  }
  ...
  public void setCounts(final Object countsIn) {
    ...
    System.arraycopy(doubles, 0, countsDouble, 0, Math.min(doubles.length, getSizeX()));
  }
