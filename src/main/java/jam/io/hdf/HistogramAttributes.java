...
public final class HistogramAttributes {
  ...
  private static final Map<String, HistogramAttributes> FULL_NAMES =
      Collections.synchronizedMap(new HashMap<String, HistogramAttributes>());
   ...
   */
  public static HistogramAttributes getHistogramAttribute(final String fullName) {
