...
/**
 * Class to represent an HDF <em>Data identifier label</em> data object. The label is meant to be a
 * short probably one or 2 word <em>label</em>.
 *
...
final class DataIDLabel extends AbstractData {
  ...
  public String toString() {
    String rval =
        "(Label \"" + label + "\": " + ((object == null) ? "null" : object.toString()) + ')';
    return rval;
  }
