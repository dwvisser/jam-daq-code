...
final class ScientificDataDimension extends AbstractData {
  ...
  /** The size of the dimensions. I have assumed identical x- and y- dimensions for 2-d spectra. */
  ...
  protected static ScientificDataDimension create(
      final short rank, final int sizeX, final int sizeY, final byte numberType) {
  ...
  private ScientificDataDimension(
      final short rank, final int sizeX, final int sizeY, final byte numberType) {
