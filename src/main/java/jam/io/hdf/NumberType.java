...
/**
 * Class to represent a 32-bit java int HDF <em>NumberType</em> data object. When constructed with
 * argument <code>NumberType.INT</code>, creates the object indicating <code>int</code> primitives.
 * When constructed with argument <code>NumberType.DOUBLE</code>, creates the object indicating
...
final class NumberType extends AbstractData {
  ...
  private static final byte NT_VERSION = 1;

  /** Unsigned int */
  private static final byte DFNT_UINT32 = 25;

  /** int */
  private static final byte DFNT_INT32 = 24;

  /** 64-bit floating point, meant for Java <code>double</code> */
  private static final byte DFNT_FLOAT64 = 6;

  /** int width, in bits */
  private static final byte INT_WIDTH = 32;

  /** double width, in bits */
  private static final byte DOUBLEWIDTH = 64;

  /** Motorola byte order, (same as Java), */
  private static final byte DFNT_MBO = 1;
   ...
   * <code>NumberType</code>. This method creates the <code>NumberType</code> objects in the file
  ...
  public void interpretBytes() {
    ...
    switch (type) {
      ...
      case DFNT_FLOAT64:
        ...
        break;
      default:
        throw new IllegalStateException("NumberType.interpretBytes(): Unrecognized number type.");
    }
  }
