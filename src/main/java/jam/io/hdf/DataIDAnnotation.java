...
/**
 * Class to represent an HDF <em>Data identifier annotation</em> data object. An annotation is
 * lenghtier than a label, and can hold a descriptive text block.
 *
...
final class DataIDAnnotation extends AbstractData {
   ...
   * @return annotation object that refers to the object witht the given tag and ref
   */
   ...
   */
  protected static <T extends AbstractData> DataIDAnnotation withTagRef(
      final List<DataIDAnnotation> labels, final Class<T> tag, final int ref) {
