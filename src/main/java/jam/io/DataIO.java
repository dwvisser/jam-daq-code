...
/** Interface to read in and write out Jam data package */
public interface DataIO {

  /**
   * Writes out to a specified file all the currently held spectra, gates, scalers, and parameters.
   *
  ...
  /**
   * Write out a file with the specified histograms and all gates that go with them, plus scalers
   * and parameters.
   *
   * @param file to write to
