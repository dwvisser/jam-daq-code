...
/**
 * This interface defines the constants need to import a XSYS data file. The following table were
 * generated from a fortran routine that was part of XSYS. Each histogram has a header which
 * includes a x_dir array. A long word is 4 bytes long.
 *
 ...
 * <DL>
 *   <DT>XSYS1DI4=1;
 *   <DD>xsys 1d I*4 data area
 *   <DT>XSYS2DI4=2;
 *   <DD>xsys 2d I*4 data area
 *   <DT>XSYS2DI2=3;
 *   <DD>xsys 2d I*2 data area
 *   <DT>XSYS1DR4=4;
 *   <DD>xsys 1d R*4 data area
 *   <DT>XSYS1DR8=5;
 *   <DD>xsys 1d R*8 data area
 *   <DT>XSYSEVAL=6;
 *   <DD>xsys eval routine
 *   <DT>XSYS2DGT=7;
 *   <DD>xsys 2d gate
 *   <DT>XSYSR4PT=8;
 *   <DD>xsys R*4 protected from clearing
 * </DL>
 *
 * @author Ken Swartz
 * @version 0.5
...
final class XsysHeader {
  ...
  /** Position of data type */
  public static final int P_AREA_DATA_TYPE = 3 * L_INT; //

  /** Position of length in words */
  public static final int P_AREA_LEN_WORD = 4 * L_INT; //

  /** ??? */
  public static final int P_AREA_LEN_PAGE = 5 * L_INT;
