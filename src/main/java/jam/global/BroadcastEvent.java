...
public final class BroadcastEvent extends PropertyChangeEvent {
  ...
  public enum Command {
    ...
    /** A point has been added by typing channels to the gate currently being set. */
    GATE_SET_ADD,
    ...
    /**
     * Counters have been received from the front end and should be updated. Message always includes
     * <code>int []</code> as the message parameter.
     */
    COUNTERS_UPDATE,
    ...
    /**
     * Announces a new fit dialog has been opened. The action associated with opening this dialog is
