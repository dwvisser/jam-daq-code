...
public final class RunState implements AcquisitionStatus {
  ...
  private static final String[] NAMES = {"NO_ACQ", "ACQ_ON", "ACQ_OFF", "RUN_ON", "REMOTE"};
  private static final String STOPPED = "   Stopped   ";
  private static final String[] LABELS = {
    "   Welcome   ", "   Started   ", STOPPED, "", "   Remote   "
  };
  private static final Color[] COLORS = {
    Color.LIGHT_GRAY, Color.ORANGE, Color.RED, Color.GREEN, Color.LIGHT_GRAY
  };
  private static final boolean[] ACQUIRE_ON = {false, true, false, true, false};
  private static final boolean[] ACQUIRE_MODE = {false, true, true, true, false};
  ...
  /**
   * Actively sorting online or offline data, but not within the context of a run.
   *
   * @see #runOnline(int)
   */
  ...
  /**
   * Online or offline acquisition is just setup, or we just ended an online or offline run/sort.
   */
  ...
  /**
   * @return <code>true</code> if this mode represents a state of actively sorting data
   * @see #ACQ_ON
   * @see #runOnline(int)
   */
  ...
  /**
   * @return <code>true</code> if this mode represents an online or offline sorting mode, regardless
   *     of whether data is actively being sorted at the moment
   * @see #ACQ_ON
   * @see #runOnline(int)
   * @see #ACQ_OFF
   */
