...
/**
 * This interface handles messages that are to be output to the screen. This usually on the
 * jam.JamConsole, but could be MessageAdaptor if the full Jam is not started up.
 *
 * @author Ken Swartz
 */
