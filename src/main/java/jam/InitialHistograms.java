...
public final class InitialHistograms {
  ...
  private final transient AbstractHistogram histInitial;

  private final transient Group groupInitial;

  /** Constructs an instance of this class. */
  public InitialHistograms() {
    super();
    final Group group = jam.data.Factory.createGroup("Initial", Group.Type.FILE);
    /* histogram with Jam name 2d */
    final AbstractHistogram histJam2d =
        Factory.createHistogram(group, histNameJam2d(), "Histogram2D", "Jam Name 2D");
    /* histogram with Jam name */
    final AbstractHistogram histJam1d =
        Factory.createHistogram(group, histNameJam1d(), "Histogram1D", "Jam Name 1D");
  ...
  private void setRange(int[] array, final int first, final int numCh, final int value) {
