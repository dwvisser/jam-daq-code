...
/**
 * Holds reference to the preferences node affecting the <code>jam.plot.color</code> package, as
 * well as the preference names.
 *
...
public final class ColorPrefs {
  ...
  public static final Preferences COLOR_PREFS = Preferences.userNodeForPackage(ColorPrefs.class);

  /** Whether to use a continuous gradient or discrete color scale. */
  public static final String SMOOTH_SCALE = "ContinuousColorScale";
}
