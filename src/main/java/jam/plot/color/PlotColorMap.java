...
public final class PlotColorMap {
  ...
  private static final PlotColorMap MAP = new PlotColorMap(Mode.B_ON_W);

  private static final Color[] OVERLAY = {
    Color.RED,
    Color.GREEN,
    Color.BLUE,
    Color.CYAN,
   ...
   */
  public static PlotColorMap getInstance() {
    return MAP;
  }
    ...
    synchronized (this) {
      if (mode == Mode.B_ON_W) {
        ...
        throw new IllegalArgumentException(
            "PlotGraphicsColorMap.setColorMap(" + mode + "): Invalid Color Mode!");
      }
