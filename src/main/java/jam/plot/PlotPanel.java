...
final class PlotPanel extends JPanel implements CountsContainer {
  ...
  private final transient MouseInputAdapter mouseInputAdapter =
      new MouseInputAdapter() {
        /**
         * Undo last temporary line drawn.
         *
         * @param mouseEvent created when mouse exits the plot
         */
        @Override
   ...
   *
   * @param moved <code>true</code> if the mouse is moving
   */
