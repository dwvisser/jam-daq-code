...
/**
 * <code>Scroller</code> contains instance of this, and it is be handed to the horizontal <code>
 * JScrollBar</code>.<code>setFields()</code> is to be called whenever the displayed <code>Histogram
 * </code> changes.
 *
 * @author Dale Visser
 * @version 1.2
