...
public final class JamInitialization {
  ...
  private static final Logger LOGGER =
      Logger.getLogger(JamInitialization.class.getPackage().getName());

  /** Configuration information for Jam. */
  private final transient JamProperties properties;
   ...
   * @param properties accessor for Jam's properties files
   * @param broadcaster handles application-wide events
   * @param menuBar menu bar
   * @param commandManager handles commands
   * @param jamToolBar iconic toolbar
   * @param sdPanel selection and display
   * @param initHists initial histograms
   * @param aars AcquisitionAndRunState instance
   * @param version jam version
   */
  @Inject
  public JamInitialization(
      final JFrame frame,
      final JamStatus status,
      final JamProperties properties,
      final Broadcaster broadcaster,
      final MenuBar menuBar,
      final CommandManager commandManager,
      final ToolBar jamToolBar,
      final SelectionAndDisplayPanel sdPanel,
      final InitialHistograms initHists,
      final AcquisitionAndRunState aars,
  ...
  private WindowListener createWindowListener(final CommandManager commandManager) {
  ...
  private void loadIcon() {
    ...
    this.frame.setIconImage(new ImageIcon(loader.getResource("jam/nukeicon.png")).getImage());
  }
