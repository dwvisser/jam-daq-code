...
final class SaveGatesCmd extends AbstractCommand {
   ...
   * Save to an hdf file.
   *
   * @param cmdParams empty array or <code>null</code> to use a file dialog, or an array with a
   *     <code>File</code> as the first element
   ...
   * Save to an hdf file.
   *
   * @param cmdTokens empty array or <code>null</code> to use a file dialog, or the name of a <code>
   *     File</code> as the first element
