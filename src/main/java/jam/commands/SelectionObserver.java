...
/**
 * Observer that is common to several commands that just observe the tree selections.
 *
 * @author Dale Visser
 */
public final class SelectionObserver implements PropertyChangeListener {
  ...
  protected SelectionObserver(final Action action, final Predicate<Nameable> predicate) {
    this.action = action;
