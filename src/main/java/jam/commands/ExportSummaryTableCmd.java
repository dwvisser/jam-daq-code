...
public class ExportSummaryTableCmd extends AbstractCommand implements PropertyChangeListener {
  ...
  private static final int BUFFER_SIZE = 256 * 2;
  ...
  private final transient SummaryTable summaryTable;
  ...
  private void saveTable(final File file) {
    try {
      ...
      LOGGER.log(Level.SEVERE, "IOException while writing table to file: " + file, ioe);
    }
  }
