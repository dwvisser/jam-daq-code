...
/**
 * Export data to file. Full implementations must assign an <code>ImpExp</code> object.
 *
 * @author Ken Swartz
 */
class AbstractExportFile extends AbstractImportExport {
   ...
   *
   * @param cmdParams <code>null</code> or 1-element array with a file reference
