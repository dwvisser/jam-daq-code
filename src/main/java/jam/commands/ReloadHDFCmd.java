...
final class ReloadHDFCmd extends AbstractLoaderHDF {
  ...
  public void initCommand() {
    ...
    putValue(
        ACCELERATOR_KEY,
        KeyStroke.getKeyStroke(KeyEvent.VK_O, CTRL_MASK | InputEvent.SHIFT_DOWN_MASK));
  ...
  private void enable() {
    ...
    final boolean online = mode == SortMode.ONLINE_DISK || mode == SortMode.ON_NO_DISK;
  ...
  private void notifyApp() {
    ...
    if (currentGroup != null) {
      GuiceInjector.getObjectInstance(JamStatus.class).setCurrentGroup(currentGroup);
