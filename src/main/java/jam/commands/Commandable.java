...
/**
 * Objects to be executed by <code>CommandManager</code> must implement this interface.
 *
 * @author Ken Swartz
 */
public interface Commandable extends Action {

  /** Performs any initial setup that wasn't possible in the constructor. */
  void initCommand();
  ...
  int CTRL_MASK = JamProperties.isMacOSX() ? InputEvent.META_DOWN_MASK : InputEvent.CTRL_DOWN_MASK;
}
