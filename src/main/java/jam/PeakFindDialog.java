...
public class PeakFindDialog extends JDialog {
  ...
  private static final Logger LOGGER =
      Logger.getLogger(PeakFindDialog.class.getPackage().getName());
  ...
  private void createDialog() {
    ...
    sensitivity.setToolTipText(
        "Greater values require better defined peaks.\n"
  ...
  private void setPeakFindProperties() {
    ...
    String msg =
        "Peak Find Properties Set: Width="
            ...
            + dSense
            + (cal
                ? ", calibrated value displayed if available, centroid channel if not."
