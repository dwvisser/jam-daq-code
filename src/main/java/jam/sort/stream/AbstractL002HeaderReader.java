...
/**
 * This class takes care of reading standard Oak Ridge L002 header records. All event input streams
 * which wish to do the same should extend this.
 *
...
public abstract class AbstractL002HeaderReader extends AbstractEventInputStream {
  ...
  /**
   * Implementers must describe their particular variant of L002 in plain English.
   *
  ...
  protected void handleGeneralException(final Exception exception) throws EventException {
    status = EventInputStatus.UNKNOWN_WORD;
    throw new EventException(
        getClass().getName() + ".readEvent() parameter = " + parameter, exception);
  }
