...
/**
 * This class knows how to handle Xsys event data format . It extends EventInputStream, adding
 * methods for reading events and returning them as int arrays which the sorter can handle.
 *
...
public class XsysInputStream extends AbstractEventInputStream {
  ...
  private static final int END_REC = 0x0a;
  ...
  /** Is the word a end of run word Xsys event stream has no end of event marker */
  @Override
