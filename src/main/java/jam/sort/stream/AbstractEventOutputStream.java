...
public abstract class AbstractEventOutputStream implements EventWriter {
   ...
   */
  public abstract boolean isEndRun(short event);
   ...
   */
  public abstract void writeEndRun() throws EventException;
   ...
   */
  public abstract void writeHeader() throws EventException;
}
