...
public abstract class AbstractEventInputStream {
  ...
  protected static final Logger LOGGER =
      Logger.getLogger(AbstractEventInputStream.class.getPackage().getName());
   ...
   * Default constructor.
   *
   * @param consoleExists whether console exists
   */
   ...
   */
  public abstract boolean isEndRun(short word);
  ...
  /**
   * Reads a byte. Only implemented as a requirement of extending <code>InputStream</code>, which
   * defines this method <code>abstract</code> .
   *
   ...
   */
  public abstract EventInputStatus readEvent(int[] event) throws EventException;
   ...
   * @exception EventException thrown if an error condition cannot be handled
   */
  public abstract boolean readHeader() throws EventException;
   ...
   * Define the console.
   *
   * @param exists whether the console exists
   */
  ...
  protected final void showErrorMessage(final Exception exception) {
    ...
    if (!consoleExists) {
      JOptionPane.showMessageDialog(null, message, cname, JOptionPane.ERROR_MESSAGE);
    }
  }
  ...
  protected final void showWarningMessage(final String string) {
    ...
    if (!consoleExists) {
      JOptionPane.showMessageDialog(null, string, cname, JOptionPane.WARNING_MESSAGE);
    }
  }
}
