...
/**
 * This class knows how to handle Oak Ridge tape format. It extends EventOutputStream, adding
...
public final class YaleOutputStream extends AbstractL002HeaderWriter {
   ...
   *
   * @exception IOException thrown for unrecoverable errors
   */
  ...
  /**
   * Writes out a event in the L002 format Implemented <code>EventOutputStream</code> abstract
   * method.
   *
   * @exception IOException thrown for unrecoverable errors
   */
   ...
   * the event stream
   */
  private void writeParameter(final short param, final short value) throws IOException {
