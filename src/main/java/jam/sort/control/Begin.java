...
class Begin extends AbstractAction {
  ...
  private final transient RunController runControl;

  private final transient Component parent;

  private final transient JTextComponent textRunTitle;

  Begin(final Component parent, final RunController runControl, final JTextComponent text) {
    super();
    this.parent = parent;
    ...
    putValue(Action.SMALL_ICON, GuiceInjector.getObjectInstance(Icons.class).BEGIN);
    setEnabled(false);
  }
