...
/**
 * Interface that generalizes to network communicate with a front end using UDP packets.
 *
 * <p>Two UDP sockets can be setup with a daemon that receives packets and knows what to do with
 * them The first int of a packet indicates what type of packet it is.
 *
...
public interface FrontEndCommunication {
  ...
  /**
   * Tell the Front End to end a run. should also flush out existing data in the front end and put a
   * end of run marker at its end of the last buffer.
   */
  void end();
  ...
  /**
   * Setup up the networking to the Front End. Called when Online data taking is setup.
   *
  ...
  /**
   * Tell the Front End to stop acquisiton, should also flushes out existing data in the front end.
   */
  void stopAcquisition();

  /**
   * Tells the Front End to reply with verbose status messages, which can be output for the user to
   * see.
   *
