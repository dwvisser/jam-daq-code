...
public interface ScalerCommunication {
  ...
  /**
   * Tell the VME to read the scalers send back to packets the packet with the scaler values and a
   * packet if read OK or ERROR and message
   */
  void readScalers();

  /**
   * Send the number of milliseconds between blocks of scaler values in the event stream.
   *
