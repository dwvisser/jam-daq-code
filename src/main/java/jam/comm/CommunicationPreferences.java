...
/**
 * Holds reference to the preferences node affecting the <code>jam</code> package, as well as the
 * preference names.
 *
...
public final class CommunicationPreferences {
  ...
  public static final Preferences PREFS =
      Preferences.userNodeForPackage(CommunicationPreferences.class);
