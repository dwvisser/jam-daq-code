...
public class SummaryTable extends JPanel implements PropertyChangeListener {
  ...
  private final transient SummaryTableModel summaryTableModel = new SummaryTableModel();
  ...
  public SummaryTable(final JamStatus status, final Broadcaster broadcaster) {
    ...
    add(scrollPane);
    final SummaryTableToolbar toolbar = new SummaryTableToolbar(summaryTableModel);
