...
public final class SelectionTreeCellRender extends DefaultTreeCellRenderer {
  ...
  private final transient Color defaultBackground;
  private final transient Icons icons;

  /**
   * Constructs a new renderer.
   *
   * @param icons application internal icons
   */
  @Inject
  ...
  public Component getTreeCellRendererComponent(
    ...
    super.getTreeCellRendererComponent(tree, value, isSelected, expanded, leaf, row, hasTheFocus);
    final Object nodeObject = ((DefaultMutableTreeNode) value).getUserObject();
