...
class SummaryTableToolbar extends JToolBar {
  ...
  private final transient JCheckBox chkShowScaler = new JCheckBox("Scalers", true);

  private final transient JCheckBox chkShowHistogram = new JCheckBox("Histograms", true);

  private final transient JCheckBox chkShowGate = new JCheckBox("Gates", true);

  private final transient SummaryTableModel summaryTableModel;
  ...
  SummaryTableToolbar(final SummaryTableModel stm) {
    ...
    final JButton bupdate =
        (iUpdate == null) ? new JButton(getHTML("<u>U</u>pdate")) : new JButton(iUpdate);
    add(bupdate);
  ...
  private String getHTML(final String body) {
    String rval = "<html><body>" + body + "</html></body>";
    return rval;
  }
}
