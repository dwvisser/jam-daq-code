...
public class ExtensionFileFilter extends FileFilter {
  ...
  /**
   * Creates and file filter for a certain extension. The description is built using the extension.
   *
  ...
  public ExtensionFileFilter(final String[] exts, final String descr) {
    ...
    final StringBuffer buffer = (descr == null) ? new StringBuffer() : new StringBuffer(descr);
    buffer.append(" (");
    for (int i = 0; i < len; i++) {
