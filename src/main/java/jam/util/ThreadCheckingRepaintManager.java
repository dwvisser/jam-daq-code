...
/**
 * Set repaint manager to this to check whether Swing and event threads are being used properly.
 *
...
public final class ThreadCheckingRepaintManager extends RepaintManager { // NOPMD
  ...
  private static final Logger LOGGER =
      Logger.getLogger(ThreadCheckingRepaintManager.class.getPackage().getName());
