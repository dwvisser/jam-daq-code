...
public class TextDisplayDialog extends JDialog {
   ...
   */
  public TextDisplayDialog(final Frame frame, final String title, final String text) {
    ...
    final int sizex = Math.min(initSize.width, screenSize.width - del - xcoord);
    final int sizey = Math.min(initSize.height, screenSize.height - del - ycoord);
