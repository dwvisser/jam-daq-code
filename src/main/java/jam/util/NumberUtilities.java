...
/**
 * Utility class for turning sequences of bytes into java ints and shorts depending on the byte
 * order conventions specified.
 *
 * @author Dale Visser
 */
@Singleton
public final class NumberUtilities {
   ...
   */
  public int bytesToInt(final byte[] array, final int offset, final ByteOrder byteOrder) {
   ...
   * @return the int represented by the bytes
   */
  public short bytesToShort(final byte[] array, final int offset, final ByteOrder byteOrder) {
