...
public class FitConsole extends JPanel implements MessageHandler {
  ...
  private final transient JScrollBar verticalBar;

  /** Create a JamConsole which has an text area for output a text field for intput. */
  public FitConsole() {
    this(100);
  }

  /**
   * Constructs a FitConsole which has an text area for output a text field for input.
   *
      ...
      if (part == NEW) {
        ...
        try {
          ...
          JOptionPane.showMessageDialog(
              this, e.getMessage(), getClass().getName(), JOptionPane.ERROR_MESSAGE);
        }
