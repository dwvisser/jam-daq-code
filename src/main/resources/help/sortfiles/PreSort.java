...
public final class PreSort {
  ...
  private PreSort(final String target, final int angle) {
    super();
    final Session scripter = GuiceInjector.getObjectInstance(Session.class);
   ...
   *
   * <p>Usage: <code>command <em>target angleDeg</em></code>
   *
   * <p><i>target</i> is one of Mg, Si, C12, or C13, and <i>angleDeg</i> is one of 10, 15, or 20.
   *
