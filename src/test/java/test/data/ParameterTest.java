...
public class ParameterTest { // NOPMD
  ...
  /** Test name properties of new parameters, when duplicate names are attempted. */
  @Test
  ...
  public void testGetSetValue() {
    ...
    assertEquals(0.0, testParameter.getValue(), 0.001, "Expected paramter inital value to be 0.");
    final double value = 3.141592;
    testParameter.setValue(value);
    assertEquals(value, testParameter.getValue(), 0.001, "Expected the value we set.");
  }
  ...
  public void testGetParameter() {
    ...
    assertSame(
        DataParameter.getParameter(paddedName),
        testParameter,
