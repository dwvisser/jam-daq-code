...
public final class GainCalibrationTest {
   ...
   *
   * @throws SortException if an unrecoverable error occurs
   */
  @Test
  public void test() throws SortException {
    ...
    assertEquals(4.1, gain.adjustExact(0, 1), 0.001, "Gain adjusted value should be 4.1");
    assertEquals(3.0, gain.adjustExact(1, 1), 0.001, "Gain adjusted value should be 3.0");
    assertEquals(0.9, gain.adjustExact(2, 1), 0.001, "Gain adjusted value should be 0.9");
  }
}
