...
public class StringUtilitiesTest { // NOPMD
  ...
  private final transient StringUtilities util =
  ...
  public final void testMakeLength() {
    ...
    Assertions.assertEquals(
        answer1, util.makeLength(test1, testLength), "Failed to lengthen String properly.");
    final String test2 = "Dale Visser";
    final String answer2 = "Dale Vis";
    Assertions.assertEquals(
        answer2, util.makeLength(test2, testLength), "Failed to shorten String properly.");
  }
  ...
  public final void testGetASCIIstring() {
    ...
    Assertions.assertEquals(
        sHell, util.getASCIIstring(hell), "Failed to convert ASCII byte array properly.");
  }
}
